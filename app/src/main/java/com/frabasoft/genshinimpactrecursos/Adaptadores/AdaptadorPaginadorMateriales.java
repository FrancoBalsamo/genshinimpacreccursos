...
public class AdaptadorPaginadorMateriales extends PagerAdapter {
    ...
    private void guardarImagenMedoto(Bitmap bitmap, String nombreImagen){
        File rutaBuilds = new File(Environment.getExternalStorageDirectory() + "/Genshin Impact Recursos/Genshin Impact Materiales Casas Mascotas/");
        if (!rutaBuilds.exists()) {
            File rutaBuildsCrear = new File(Environment.getExternalStorageDirectory() + "/Genshin Impact Recursos/Genshin Impact Materiales Casas Mascotas/");
